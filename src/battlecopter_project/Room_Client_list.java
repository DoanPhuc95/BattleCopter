...
public class Room_Client_list {
    ...
    public void logout(SocketID SOCK)
    {
        Client_list.remove(SOCK.getName());
    }
    public boolean checkLogin(String username)
    {
        if(Client_list.get(username)!=null) return false;
        if(Playing_client.get(username)!=null) return false;
        return true;
    }
